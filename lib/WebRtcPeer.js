  ...
  if (mode !== "recvonly" && !videoStream && !audioStream) {
    function getMedia(constraints) {
      ...
      mediaDevices
        ...
        .then(sourceInfos => {
          ...
          for (let i = 0; i < sourceInfos.length; i++) {
            ...
            if ((sourceInfo.kind == "video" && sourceInfo.facing == "front") ||
             (sourceInfo.label && sourceInfo.label.toLowerCase().indexOf("front") !== -1)) {
               console.log("/////////////////////////////////////////// setting sourceInfo", sourceInfo);
              videoSourceId = sourceInfo.id || sourceInfo.deviceId;
        ...
        .then(stream => {
          console.log("//////////// is ios value: ", isIOS);
          if(isIOS) {
